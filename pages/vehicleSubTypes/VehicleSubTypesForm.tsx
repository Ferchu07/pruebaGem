...
interface FormVehicleSubTypeProps {
    isLoading: boolean;
    submit: Function;
    data?: VehicleSubType | undefined;
    onClose: () => void;
}
...
const VehicleSubTypesForm: React.FC<FormVehicleSubTypeProps> = ({ isLoading, submit, data, onClose }) => {
            ...
            <Page container="fluid">
                <div className="@container">
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <FormFooter
                            submitBtnText={mode + ' subtipo de vehículo'}
...
export default VehicleSubTypesForm;
